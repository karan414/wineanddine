...
import com.example.karan.winedine.OrderItemFragment.OnListFragmentInteractionListener;
...
public class MyOrderItemRecyclerViewAdapter extends RecyclerView.Adapter<MyOrderItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyOrderItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(holder.mStatusView.getText().toString().equals("complete"))
