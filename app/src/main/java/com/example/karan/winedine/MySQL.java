...
public class MySQL extends SQLiteOpenHelper {
    ...
    static String dbname = "wddb.db";
    Context cc;
    SQLiteDatabase mydb = null;
    String dbpath = "/data/data/com.example.karan.winedine/databases/";
    ...
    public void checkMydb() {
        ...
        try {
            ...
            Toast.makeText(cc, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
        }
        ...
        if (mydb == null) {
            ...
            try {
                ...
                Toast.makeText(cc, "Error : " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        } else {
